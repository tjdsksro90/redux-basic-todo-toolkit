...
const todosSlice = createSlice({
  ...
  reducers: {
    // 불변성을 유지시켜야 한다!
    // state.push(action.payload); x
    // 근데 실행은 잘 됨
    // 이유는 redux toolkit 안에 immer 라는 기능이 내장되어있기 떄문
    // 참고 사이트 => doesitmutate.xyz
...
// [slice] = 1. export creator 2. export reducer 3. action value
// slice는 오른쪽 3개와 같은 기능이다.
